...
simulation_mesure.exe: $(OBJS) simulation_mesure.cpp
	$(CXX) $(CXXFLAGS) $(OBJS) simulation_mesure.cpp -o simulation_mesure.exe $(LIBS)

simulation_sync_affiche_mpi.exe: $(OBJS) simulation_sync_affiche_mpi.cpp
	$(CXX) $(CXXFLAGS) $(OBJS) simulation_sync_affiche_mpi.cpp -o simulation_sync_affiche_mpi.exe $(LIBS)

simulation_asynchrone.exe: $(OBJS) simulation_asynchrone.cpp
	$(CXX) $(CXXFLAGS) $(OBJS) simulation_asynchrone.cpp -o simulation_asynchrone.exe $(LIBS)

simulation_async_omp.exe: $(OBJS) simulation_async_omp.cpp
	$(CXX) $(CXXFLAGS) -fopenmp $(OBJS) simulation_async_omp.cpp -o simulation_async_omp.exe $(LIBS)
