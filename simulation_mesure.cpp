...
void simulation(bool affiche)
{
    ...
    clock_t step1_time = clock();
    clock_t total_computing_time = 0;
    clock_t total_displaying_time = 0;
    ...
    while (!quitting)
    {
        ...
        clock_t step2_time = clock();
        total_computing_time += (step2_time - step1_time);
        //#############################################################################################################
        ...
        clock_t step3_time = clock();
        total_displaying_time += (step3_time - step2_time);
        //std::cout<<step2_time - step1_time<< ", "<<step3_time - step2_time<<std::endl;

        step1_time = step3_time;
    ...
    std::cout<<"Moyenne : "<<(end_time-start_time)/150<<std::endl;
    std::cout<<"Part d'affichage dans le temps de calcul : "<<100*total_displaying_time/(total_computing_time+total_displaying_time)<<"%"<<std::endl;
}
